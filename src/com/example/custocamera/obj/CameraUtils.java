package com.example.custocamera.obj;
...
public class CameraUtils {
    ...
    public static final int DEFAULT_WIDTH = 600;//1280;
    public static final int DEFAULT_HEIGHT = 900;//720;
    public static final int DESIRED_PREVIEW_FPS = 30;

    private static int mCameraID = Camera.CameraInfo.CAMERA_FACING_FRONT; // 代表摄像头的方位，目前有定义值两个分别为CAMERA_FACING_FRONT前置和CAMERA_FACING_BACK后置  
